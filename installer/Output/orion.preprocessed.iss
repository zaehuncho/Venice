...
Name: "{autodesktop}\Venice"; Filename: "{app}\OrionNative.exe"; Tasks: desktopicon
[Run]
...
Filename: "{tmp}\ViGEmBus_1.22.0_x64_x86_arm64.exe"; Parameters: "/quiet /norestart"; StatusMsg: "Installing ViGEmBus virtual-controller driver..."; Flags: waituntilterminated; Check: NeedsViGEmBus
Filename: "{tmp}\HidHide_1.5.230_x64.exe"; Parameters: "/quiet /norestart"; StatusMsg: "Installing HidHide controller-cloak driver..."; Flags: waituntilterminated; Check: NeedsHidHide
...
Filename: "{app}\OrionNative.exe"; Description: "{cm:LaunchProgram,Venice}"; Flags: nowait postinstall skipifsilent
[UninstallRun]
