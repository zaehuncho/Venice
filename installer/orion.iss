...
#if FileExists(SourcePath + "assets\venice-wizard-100.bmp")
  WizardImageFile={#SourcePath}assets\venice-wizard-100.bmp,{#SourcePath}assets\venice-wizard-150.bmp,{#SourcePath}assets\venice-wizard-200.bmp
#endif
...
Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#LaunchExeName}"
...
begin
  ...
  if CompareText(ExpandConstant('{app}'),
                 ExpandConstant('{autopf}\{#MyAppName}')) <> 0 then
